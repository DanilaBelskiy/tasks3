...
public class AllTasks {
    ...
    // Return index of char where starts "zip" number N
    // Task 2 ----------------------------------------------------------------------------------------------------------
    ...
    // Return true if number is perfect (it is equal to the sum of its factors)
    // Task 3 ----------------------------------------------------------------------------------------------------------
    ...
    // Returns string with flipped extreme chars (or exception)
    // Task 4 ----------------------------------------------------------------------------------------------------------
    ...
    // Return true if string id valid hex code
    // Task 5 ----------------------------------------------------------------------------------------------------------
    ...
    // Returns true if two arrays have same numbers of unique numbers
    // Task 6 ----------------------------------------------------------------------------------------------------------
    public static boolean same(int[] arr1, int[] arr2) {
        return unique_count(arr1) == unique_count(arr2);
    }

    // Returns number of unique numbers in array
    ...
    // Returns true if number is number of Kaprekar
    // Task 7 ----------------------------------------------------------------------------------------------------------
    ...
    // Returns length of the longest string of zeros from string
    // Task 8 ----------------------------------------------------------------------------------------------------------
    ...
    // Return true if given numbers = sides of right triangle
    // Task 10 ---------------------------------------------------------------------------------------------------------
